...
func NewLlamaServer(gpus discover.GpuInfoList, modelPath string, f *ggml.GGML, adapters, projectors []string, draftModel string, df *ggml.GGML, opts api.Options, numParallel int) (LlamaServer, error) {
	...
	if draftEstimate != nil {
		slog.Info("draft offload", "", draftEstimate)
	}
